...
export interface ApiActivityLLogActivityLLog
  extends Struct.CollectionTypeSchema {
  collectionName: 'activity_l_logs';
  info: {
    displayName: 'ActivityLLog';
    pluralName: 'activity-l-logs';
    singularName: 'activity-l-log';
  };
  options: {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::activity-l-log.activity-l-log'
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    activity_l_logs: Schema.Attribute.Relation<
      'oneToMany',
      'api::activity-l-log.activity-l-log'
    >;
