        ...
        <form onSubmit={handleSubmit} className="login-form">
          ...
          {state !== 'login' && (
            <div className="mt-4">
              ...
              <div className="relative mt-2">
                ...
                value={username}
                 type="text" placeholder="Enter a valid username" 
          ...
          <div className="mt-4">
              ...
              <div className="relative mt-2">
                ...
                value={email}
                 type="email" placeholder="Please Enter your valid email" 
                 className="login-input" 
                 required />
              </div>
            </div>
          ...
          <div className="mt-4">
              ...
              <div className="relative mt-2">
                ...
                placeholder="Please Enter your password" 
                 ...
                 />
                 <button className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-600" onClick={() => setShowPassword((p) => !p)}>
